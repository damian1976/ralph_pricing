...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExtraCost.only_for_admin'
        db.add_column(u'ralph_scrooge_extracost', 'only_for_admin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExtraCost.only_for_admin'
        db.delete_column(u'ralph_scrooge_extracost', 'only_for_admin')
    ...
    models = {
        ...
        u'ralph_scrooge.extracost': {
            ...
            'forecast_cost': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '16', 'decimal_places': '6'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'only_for_admin': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'remarks': ('django.db.models.fields.TextField', [], {'default': "u''", 'blank': 'True'}),
